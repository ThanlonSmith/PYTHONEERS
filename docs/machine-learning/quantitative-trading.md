...
<a class="gh-btn" href="javascript:;" rel="noopener noreferrer" target="_blank" aria-label="Star encode/django-rest-framework on GitHub">
    ...
    <div style="position: relative;float: right">
        <a target="_blank" href="https://blog.csdn.net/thanlon" id="weibo"
           style="display: block;width: 40px;height: 40px;background-color: #c4351b;margin-top: 1px;">
            <img width="22" height="20" src="../img/csdn.jpeg" alt="去CSDN关注我" title="去CSDN关注我"
